...
function D3Core(options) {
    ...
    var defaultOptions = {
		...
		dataUrl: null,
		data:[
{key:"Vacant",values:[	{x:'Detached Houses',y:371},
	{x:'Semi-Detached Houses',	y:736},
	{x:'Terrace Houses',	y:1332},
	{x:'Apartments',	y:5561},
	{x:'Condominium Units',	y:10003}]},
{key:"Available",values:[	{x:'Detached Houses',y:10638},
	{x:'Semi-Detached Houses',	y:21538},
	{x:'Terrace Houses',	y:38873},
	{x:'Apartments',	y:73950},
	{x:'Condominium Units',	y:144371}]},
]				,
		resizable: true,
		showLegend: true,
		showTooltip: true,
		...
		colors: ["#b30000",'steelblue','rgb(178,223,138)','rgb(51,160,44)','rgb(251,154,153)','rgb(227,26,28)','rgb(253,191,111)','rgb(255,127,0)','rgb(202,178,214)','rgb(106,61,154)','rgb(255,255,153)','rgb(177,89,40)'],
		...
		tooltipText: function(d, element) { return "<p>Type: "+d.x+"<br />Units:"+d.y+"<p>"; }
	}	
